...
/* Visual-only mining animation. No mining state, reward, balance or API logic is changed. */
(function installMiningAnimation(){
 const css='.mining-module.active .mining-module-icon{position:relative;animation:mmMinerBob 1.15s ease-in-out infinite;will-change:transform}.mining-module.active .mining-module-icon::after{content:"⛏";position:absolute;right:-8px;top:-10px;font-size:15px;transform-origin:80% 85%;animation:mmPickaxeSwing .72s ease-in-out infinite;filter:drop-shadow(0 2px 3px #0008);pointer-events:none}.mining-module.active .mining-module-button{position:relative;overflow:hidden;background:#63e69a;box-shadow:0 0 0 1px #63e69a55,0 0 14px #63e69a22;isolation:isolate}.mining-module.active .mining-module-button::after{content:"";position:absolute;inset:-60% -30%;background:linear-gradient(105deg,transparent 38%,#ffffff00 43%,#ffffff66 49%,#ffffff00 55%,transparent 62%);transform:translateX(-80%);animation:mmCurrentModuleGlow 2.4s ease-in-out infinite;pointer-events:none}.mining-module.active .mining-module-button:disabled{color:#07100b;opacity:1}.mining-module.active{box-shadow:0 0 0 1px #285d3d inset}.mining-module.active .mining-module-icon{filter:drop-shadow(0 0 5px #63e69a22)}@keyframes mmMinerBob{0%,100%{transform:translateY(0) rotate(-2deg)}45%{transform:translateY(-2px) rotate(2deg)}70%{transform:translateY(1px) rotate(-1deg)}}@keyframes mmPickaxeSwing{0%,100%{transform:rotate(-38deg)}45%{transform:rotate(25deg)}60%{transform:rotate(32deg)}75%{transform:rotate(-8deg)}}@keyframes mmCurrentModuleGlow{0%{transform:translateX(-80%)}48%,100%{transform:translateX(80%)}}@media(prefers-reduced-motion:reduce){.mining-module.active .mining-module-icon,.mining-module.active .mining-module-icon::after,.mining-module.active .mining-module-button::after{animation:none}}';if(document.getElementById('mmMiningAnimationStyle'))return;const style=document.createElement('style');style.id='mmMiningAnimationStyle';style.textContent=css;(document.head||document.documentElement).appendChild(style);})();