...
function renderCasino(){
 ...
 document.querySelectorAll('#rouletteBetChoices [data-choice]').forEach(b=>{b.classList.toggle('selected',b.dataset.choice===casinoChoice);b.disabled=casinoBusy||!casinoSessionValid();});
